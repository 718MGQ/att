...
<body>
    ...
    <div id="box">
        ...
        <div id="bodybox">
            <div id="addbox">
                <div></div>
                <button class="addbutton"><a style="text-decoration: none" class="link"  onclick="window.location.assign('/index.php/Home/User/sign_out');">注&emsp;销</a></button>
            </div>
            <div id="checkbox">
                <div id="check">
                    <div id="time">
    ...
    <script>
        function play(){
            $.ajax({
                url : '/index.php/Home/User/kaoqin',
                method : 'post',
